        ...
        {tools.map((tool, i) => (
          ...
          >
            <div style={{
              ...
              background: tool.type === 'builtin' ? 'rgba(139, 92, 246, 0.12)' : 'rgba(34, 197, 94, 0.12)',
              display: 'flex',
              alignItems: 'center',
                  ...
                  <div style={{ display: 'flex', gap: '4px' }}>
                    <button
                      ...
                      style={{
                        ...
                        background: paramMode === 'simple' ? 'rgba(139, 92, 246, 0.12)' : 'var(--bg-elevated)',
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: paramMode === 'advanced' ? 'rgba(139, 92, 246, 0.12)' : 'var(--bg-elevated)',
